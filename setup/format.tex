...
\titlecontents{subsection}[4em]{\vspace{-0.2\baselineskip}\xiaosi\song}
	{\thecontentslabel\quad}{}
	{\!\titlerule*[5pt]{$\cdot$}\!\!\!\!\xiaosi\contentspage}
\titlecontents{subsubsection}[5em]{\vspace{-0.3\baselineskip}\xiaosi\song}
	{\thecontentslabel\quad}{}
	{\!\titlerule*[5pt]{$\cdot$}\!\!\!\!\xiaosi\contentspage}
...
%% 下面的代码来自fixCJK.tex by Werner Lemberg <wl@gnu.org>，使得natbib 可
...
\fancyhead[OC]{ \song\wuhao \@cheading}
\fancyhead[EC]{ \song\wuhao {\@ctitle}}
...
%%\chapter*{\centering\sanhao\hei\bfseries 论文原创性声明}
%\vspace*{6.3cm}
%
%\begin{center}
%  \sanhao\hei{论文原创性声明}
...
%%\chapter*{\centering\sanhao\hei\bfseries 学位论文使用授权声明}
%\vspace*{6.3cm}
%\begin{center}
%  \sanhao\hei{学位论文使用授权声明}
%\end{center}
%\vspace*{2cm}
%\xiaosi\song\defaultfont
...
%\begin{center}
%\linespread{1.95}
%  \xiaosan\song{专业：\@csubject}\\
%    硕士生：\@cauthor \\
%	指导教师：\@csupervisor
%\end{center}
%\vspace{0.05cm}
%\begin{flushleft}
%\setlength{\@title@width}{15cm}
%  {\sanhao\song{
%	\begin{tabular}{c}
%	\@ctitle\\
%	专业：\@csubject \\
...
\hangafter=1\hangindent=52.3pt\indent
...
%\pdfbookmark[1]{ABSTRACT}{eabstract}
...
%% 改过的格式
%\begin{center}
%  \xiaosan{Controllability and dynamic optimization for macroscopic fundamental diagram based multi-region urban networks}\\
%  {Major: \@esubject}\\
%    Name: \@eauthor \\
...
%  {\xiaosi{
%  \begin{tabular}{c}
%	 Boundary conditions and optimal control for multi-region\\
% macroscopic fundamental diagram systems\\
%    Major: \@esubject \\
%    Name: \@eauthor \\
%    Supervisor: \@esupervisor \\
%  \end{tabular}}
...
\hangafter=1\hangindent=60pt\indent
