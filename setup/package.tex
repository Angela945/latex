...
\usepackage[a4paper,%text={130true mm,228 true mm},
left=25 true mm,right=25 true mm,
top=33true mm,bottom=38true mm,
head=6true mm,headsep=10true mm,
foot=16.5true mm]{geometry}
% 支持版面尺寸设置
% 支持国际标准单位
...
\usepackage{amssymb} \renewcommand{\algorithmicrequire}{\textbf{Input:}} % Use Input in the format of Algorithm
